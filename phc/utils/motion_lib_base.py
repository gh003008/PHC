...
class MotionLibBase():
    ...
    def load_motions(self, skeleton_trees, gender_betas, limb_weights, random_sample=True, start_idx=0, max_len=-1):
        ...
        mp.set_sharing_strategy('file_system')  # was 'file_descriptor' — 'file_system' avoids "received 0 items of ancdata" / BrokenPipeError when 3+ concurrent jobs load motion library with 64 workers each
