...
V4b: V3 + ALPHA_TRACK 5.0 → 20.0 (sharper r_track Gaussian) (vs V2, see 01_research_docs/260502_personalized_diverse_motion_roadmap.md):
...
class HumanoidImResAMPVCmdV4b(HumanoidIm):
    ...
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless):
        ...
        if _DIAG_PIN_VCMD_VAL is not None:
            print(f"[V4b diag] PHC_PIN_VCMD={_DIAG_PIN_VCMD_VAL} → v_cmd pinned for all envs")
    ...
    def _install_motion_lib_patch(self):
        ...
        def patched_sample_motions(n: int):
            ...
            if buf is not None:
                ...
                print(f"[V4b] WARN: pending_forced_clips shape {buf.shape} != n={n}, using orig sampler")
    ...
    W_TRACK = 0.5
    W_IM = 0.2
    ALPHA_TRACK = 20.0   # V4b: sharper Gaussian (was 5.0 in V3)
    ALPHA_IM = 2.0
