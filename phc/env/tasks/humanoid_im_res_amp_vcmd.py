...
class HumanoidImResAMPVCmd(HumanoidIm):
    ...
    def _compute_reward(self, actions):
        ...
        # Populate self.reward_raw — parent (HumanoidIm) allocates this with 5 cols
        # when power_reward=True. AmpAgent._assemble_train_info indexes [0..4] for
        # logging. We repurpose those slots to expose our task-side components:
        #   [0]=r_track  [1]=r_im  [2..4]=0 (placeholders for parent's body_rot/lin_vel/ang_vel/power)
