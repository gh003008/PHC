...
# AMASS_CMD_V2_A: winner cmd_tracking_w=0.5 + personalization (body shape variation)
# Round 1 winner's config (B, w=0.5) + has_shape_variation ON + has_shape_obs ON
