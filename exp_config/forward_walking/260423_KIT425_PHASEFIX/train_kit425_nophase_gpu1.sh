...
# KIT_425 Slot 2 NOPHASE: cycle_motion=False, vic_phase_obs=False (phase ablation).
...
python phc/run.py \
  ...
  --cfg_env exp_config/forward_walking/260423_KIT425_PHASEFIX/env_im_walk_vic_kit425_nophase.yaml \
  --cfg_train exp_config/forward_walking/260423_KIT425_PHASEFIX/im_walk_vic_kit425.yaml \
  --headless --num_envs 512 --no_log \
  --experiment KIT425_NOPHASE
